...
import io.liftgate.aware.connection.WrappedRedisPubSubListener
import io.liftgate.aware.subscription.AwareSubscriptionContext
import io.liftgate.aware.subscription.AwareSubscriptionContextTypes
...
)
{
    ...
    private val client by lazy {
        io.liftgate.aware.AwareHub.client()
    }
    ...
    fun connect(): CompletionStage<Void>
    {
        ...
        publishConnection = if (io.liftgate.aware.AwareHub.publishUri != null)
        {
            client.connect(
                codec, io.liftgate.aware.AwareHub.publishUri!!
            )
        } else
        {
    ...
    )
    {
        ...
        if (expiresIn.isNotEmpty())
        {
            ...
            io.liftgate.aware.AwareHub.scheduler.schedule(
                {
